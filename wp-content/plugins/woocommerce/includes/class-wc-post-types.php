	...
	public static function register_post_types() {
		...
		register_post_type(
			...
			apply_filters(
				...
				array(
					'labels'              => array(
						'name'                  => __( 'Продукти', 'woocommerce' ),
						'singular_name'         => __( 'Продукт', 'woocommerce' ),
						'all_items'             => __( 'Усі товари', 'woocommerce' ),
						'menu_name'             => _x( 'Продукти', 'Admin menu name', 'woocommerce' ),
						'add_new'               => __( 'Додати новий продукт', 'woocommerce' ),
						'add_new_item'          => __( 'Додати новий продукт', 'woocommerce' ),
						'edit'                  => __( 'Редагувати продукт', 'woocommerce' ),
						'edit_item'             => __( 'Edit product', 'woocommerce' ),
						'new_item'              => __( 'New product', 'woocommerce' ),
						'view_item'             => __( 'View product', 'woocommerce' ),
						'view_items'            => __( 'View products', 'woocommerce' ),
						'search_items'          => __( 'Знайти продукти', 'woocommerce' ),
						'not_found'             => __( 'Не знайдено продуктів', 'woocommerce' ),
						'not_found_in_trash'    => __( 'Не знайдено продуктів', 'woocommerce' ),
